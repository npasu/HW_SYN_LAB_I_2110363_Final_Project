module top_module (
    ...
    wire [16:0] write_addr;     // 17 bits for 76800 addresses
    wire [11:0] capture_data;   // 12 bits for RGB444
    ...
    wire [16:0] read_addr;      // 17 bits for 76800 addresses
    wire [11:0] bram_data;      // 12 bits for RGB444
